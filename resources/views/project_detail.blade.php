            ...
            <div class="container">
                <div class="row">
                    <div class="page-head-content">
                        <h1 class="page-title">{{$bds->title}} </h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="clearfix padding-top-40">
                    <div class="col-md-8 single-property-content ">
                            ...
                            <div class="light-slide-item">
                                <div class="clearfix">
                                    ...
                                    <ul id="image-gallery" class="gallery list-unstyled cS-hidden">
                                        <li data-thumb="{{asset('img/upload/buy')}}{{'/'.$bds->image}}">
                                            <img src="{{asset('img/upload/buy')}}{{'/'.$bds->image}}" />
                                        </li>
                                        {{-- <li data-thumb="../layouts/mg/property-1/property2.jpg">
                                            <img src="../layouts/img/property-1/property3.jpg" />
                                        </li>
                                        <li data-thumb="../layouts/img/property-1/property3.jpg">
                                            <img src="../layouts/img/property-1/property3.jpg" />
                                        </li>
                                        <li data-thumb="../layouts/img/property-1/property4.jpg">
                                            <img src="../layouts/img/property-1/property4.jpg" />
                                        </li> --}}
                        ...
                        <div class="single-property-wrapper">
                            ...
                            <h1 class="property-title pull-left">{{$bds->title}}</h1>

                            <span class="property-price pull-right">${{$bds->price}} Tỷ</span>
                            </div>
                            <div class="single-property-header">
                            ...
                            <div class="property-meta entry-meta clearfix ">
                                ...
                                <div class="col-xs-3 col-sm-3 col-md-3 p-b-15">
                                    ...
                                    <span class="property-info-entry">
                                        ...
                                        <span class="property-info-value">Đang rao bán</span>
                                    </span>
                                </div>
                                ...
                                <div class="col-xs-3 col-sm-3 col-md-3 p-b-15">
                                    ...
                                    <span class="property-info-value">{{$bds->dt}}<b class="property-info-unit">m2</b></span>
                                    </span>
                                </div>
                            ...
                            <div class="section property-video">
                                ...
                                <div class="video-thumb">
                                    <a class="video-popup" href="yout" title="Virtual Tour">
                                        <img src="../layouts/img/property-video.jpg" class="img-responsive wp-post-image" alt="Exterior">
                                    </a>
                                </div>
                            </div>
                            <!-- End video area  -->
                                    ...
                                    <div class="inner-wrapper">
                                        ...
                                        <div class="clear">
                                            <div class="col-xs-4 col-sm-4 dealer-face">
                                                <a href="">
                                                    <img src="../layouts/img/client-face1.png" class="img-circle">
                                                </a>
                                            </div>
                                            <div class="col-xs-8 col-sm-8 ">
                                                <h3 class="dealer-name">
                                                    <a href="">Đinh Thanh Huy</a>
                                        ...
                                        <div class="clear">
                                            <ul class="dealer-contacts">
                                                <li><i class="pe-7s-mail strong"> </i> thanhhuy6220@gmail.com</li>
                                                <li><i class="pe-7s-call strong"> </i> 908 967 5906</li>
                                            </ul>
